  ...
  return (
    <div className="App">
      <nav className="navbar navbar-expand-md navbar-light ml-2">
        ...
        <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggler" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation">
